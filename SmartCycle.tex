...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Storyboard/t1.1.png}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Storyboard/t1.2.png}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Storyboard/t1.3.png}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \leftskip -4.65cm
        \includegraphics[width=\textwidth]{Storyboard/t1.4.png}
    \end{subfigure}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Storyboard/t2.1.png}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Storyboard/t2.2.png}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Storyboard/t2.3.png}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \leftskip -4.65cm
        \includegraphics[width=\textwidth]{Storyboard/t2.4.png}
    \end{subfigure}
\end{figure}
