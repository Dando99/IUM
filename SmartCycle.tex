...
\begin{enumerate}[label=\textbf{Task-\arabic*}]
    \item L'utente filtra i risultati dei locali per disponibilità di donazione a persone bisognose e Città, sceglie un locale e acquista una box di cibo invenduto da donare.
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Scegliere un locale da cui acquistare una box di cibo invenduto da donare (box standard, non personalizzabili).
